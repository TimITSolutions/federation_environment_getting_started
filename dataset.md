...
## csv files
The [datasets](./dataset) folder also contains csv files with the list of the [cases](./dataset/clam-details-case.csv) and their corresponding case-level diagnosis of malignant or benign and list of [images in the cases](./dataset/clam-details-image.csv). 
