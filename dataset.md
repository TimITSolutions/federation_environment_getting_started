...
|Groundtruth                    | Case-level or exam-level diagnosis of malignant or benign. Possible Values: malignant or  benign.         |
|Split                          | indicates whether the case is included in the train or test set. Possible values: train or test.           |
